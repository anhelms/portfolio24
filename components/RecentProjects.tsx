...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
        ...
        <div className="flex flex-wrap items-center justify-between p-4 gap-x-24 gap-y-8 mt-10">
            {projects.map(({ id, title, des, img, iconLists, link }) => (
                <div key={id} className="sm:h-[41rem] lg:min-h-[32.5rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[90vw]">
                    <PinContainer title={link} href={link}>
                        ...
                        <p className="lg:text-xllg:font-normal font-light text-sm line-clamp-2">
                            {des}
                        </p>
